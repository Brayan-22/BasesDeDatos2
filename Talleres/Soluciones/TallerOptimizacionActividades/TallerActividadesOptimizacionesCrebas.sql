...
drop index IF EXISTS persona_activdad_FK;

drop index IF EXISTS Actividad_PK;

drop table IF EXISTS Actividad;

drop index IF EXISTS actividad_avance_FK;

drop index IF EXISTS Avance_PK;

drop table IF EXISTS Avance;

drop index IF EXISTS tipo_inconveniente_FK;

drop index IF EXISTS avance_inconveniente_FK;
...
drop index IF EXISTS TipoInconveniente_PK;

drop table IF EXISTS TipoInconveniente;
